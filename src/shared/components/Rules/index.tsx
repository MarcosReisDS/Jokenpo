...
const Rules: FC<IRules> = ({handleClose}) => {
    return (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="304" height="270">
                    ...
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <g transform="translate(98 160)">
                            <ellipse cx="53.686" cy="54.815" fill="#B1B4C5" rx="53.686" ry="54.815" />
                            <ellipse cx="53.686" cy="52.385" fill="url(#b)" rx="53.686" ry="52.385" />
                            <g transform="translate(12.473 12.421)"><ellipse cx="41.214" cy="41.044" fill="#E1E4ED" rx="41.214" ry="41.044" />
                        ...
                        <text fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="10" font-style="condensed" font-weight="bold">
                            <tspan x="134" y="31">GANHAR</tspan>
                        </text>
                        <text fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="10" font-style="condensed" font-weight="bold">
                            <tspan x="40" y="147">GANHAR</tspan>
                        </text>
                        <text fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="10" font-style="condensed" font-weight="bold">
                            <tspan x="235" y="147">GANHAR</tspan>
                        </text>
